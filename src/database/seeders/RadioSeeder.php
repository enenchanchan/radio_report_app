...
全てのメールアドレスは ss@allnightnippon.com まで
 '
            ...
            [
                'radio_title' => 'アルコ&ピース D.C.GARAGE',
                'radio_date' => '火曜日',
                'start_time' => '00:00',
                'end_time' => '01:00',
                'broadcaster' => 'TBSラジオ',
            ...
            [
                ...
                「怒りんぼ田中裕二』
                「こんばんは田中裕二です」から始まる、
                田中さんがいかにも怒りそうなエピソードを送って貰うコーナー。
                田中さんには「超むかつく・むかつく・平気」の3段階で評価してもらいます。

                『CD田中』
                曲の歌詞の一部に、田中さんのセリフを勝手にくっつけて作品を作ってもらうコーナー。
                曲名と該当する歌詞、そしていつのどの田中のセリフなのかを明記して送ってください。

                『カーボーイ大穴予想』
                その日の放送で起こりそうなことを送って貰います。ただし大穴の予想限定です。'
            ]
